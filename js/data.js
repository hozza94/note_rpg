...
const GAME_DATA = {
    ...
    regions: {
        ...
        'twilight_reach': {
            ...
            name: '황혼의 어귀',
            minLevel: 78,
            bossId: 'twilight_arbiter',
            nextRegionId: null,
            themeColor: '#7e57c2',
            description: '낙원이 무너진 뒤에만 열리는 잔광의 강어귀. 심판의 잔향이 아직 걷히지 않았습니다.',
            fieldGradeMin: 'SSS',
            fieldGradeMax: 'SSS',
            recommendedPlayerLv: { min: 76, max: 95 },
            enemyPowerTier: 11
        }
    },
    ...
    bossDungeon: {
        entries: [
            ...
            { bossId: 'twilight_arbiter', regionId: 'twilight_reach', recommendedLv: 88, unlockType: 'region_reached' }
        ]
    },
    ...
    monsters: [
        ...
        { id: "bog_leech_swarm", tags: ["field","gihon"], regionId: "gihon", grade: "D", name: "늪거머리 떼", level: 14, minPlayerLv: 9, maxPlayerLv: 99, stats: { hp: 620, atk: 62, def: 28, spd: 125 }, reward: { exp: 480, gold: 175 }, dropTableId: "drop_d_snake", skillTreeId: "st_bite_only" },
        { id: "fen_wisp_cluster", tags: ["field","gihon"], regionId: "gihon", grade: "C", name: "습지 불빛 무리", level: 17, minPlayerLv: 10, maxPlayerLv: 99, stats: { hp: 880, atk: 78, def: 42, spd: 155 }, reward: { exp: 580, gold: 215 }, dropTableId: "drop_c_skeleton", skillTreeId: "st_wail_only" },
        ...
        { id: "dust_devil", tags: ["field","hidekel"], regionId: "hidekel", grade: "C", name: "먼지 악령", level: 21, minPlayerLv: 16, maxPlayerLv: 99, stats: { hp: 1280, atk: 118, def: 62, spd: 198 }, reward: { exp: 840, gold: 330 }, dropTableId: "drop_c_hidekel", skillTreeId: "st_fear_only" },
        { id: "glass_scorpion", tags: ["field","hidekel"], regionId: "hidekel", grade: "B", name: "유리 전갈", level: 25, minPlayerLv: 17, maxPlayerLv: 99, stats: { hp: 2100, atk: 168, def: 95, spd: 145 }, reward: { exp: 1320, gold: 520 }, dropTableId: "drop_b_hidekel", skillTreeId: "st_bite_only" },
        ...
        { id: "blood_reaper", tags: ["field","euphrates"], regionId: "euphrates", grade: "A", name: "선혈의 수확자", level: 33, minPlayerLv: 26, maxPlayerLv: 99, stats: { hp: 4800, atk: 252, def: 158, spd: 172 }, reward: { exp: 2550, gold: 900 }, dropTableId: "drop_a_euphrates", skillTreeId: "st_bite_only" },
        { id: "trench_phantom", tags: ["field","euphrates"], regionId: "euphrates", grade: "S", name: "참호의 허상", level: 34, minPlayerLv: 27, maxPlayerLv: 99, stats: { hp: 5800, atk: 278, def: 172, spd: 168 }, reward: { exp: 2980, gold: 990 }, dropTableId: "drop_a_euphrates", skillTreeId: "st_fear_only" },
        ...
        { id: "oath_phantom", tags: ["field","eden_core"], regionId: "eden_core", grade: "A", name: "맹세의 허깨비", level: 37, minPlayerLv: 32, maxPlayerLv: 99, stats: { hp: 4900, atk: 298, def: 198, spd: 188 }, reward: { exp: 3400, gold: 1280 }, dropTableId: "drop_a_eden", skillTreeId: "st_wail_root" },
        { id: "halo_shredder", tags: ["field","eden_core"], regionId: "eden_core", grade: "S", name: "고리의 찢는 자", level: 43, minPlayerLv: 34, maxPlayerLv: 99, stats: { hp: 8600, atk: 362, def: 228, spd: 208 }, reward: { exp: 5800, gold: 1980 }, dropTableId: "drop_s_eden", skillTreeId: "st_stone_seraph_boss" },
        ...
        { id: "memory_wisp", tags: ["field","periphery"], regionId: "periphery", grade: "A", name: "기억의 잔불", level: 41, minPlayerLv: 40, maxPlayerLv: 99, stats: { hp: 5400, atk: 305, def: 200, spd: 195 }, reward: { exp: 5200, gold: 1620 }, dropTableId: "drop_periphery_field", skillTreeId: "st_fear_only" },
        { id: "echo_knight", tags: ["field","periphery"], regionId: "periphery", grade: "SS", name: "메아리 기사", level: 47, minPlayerLv: 41, maxPlayerLv: 99, stats: { hp: 7600, atk: 372, def: 242, spd: 182 }, reward: { exp: 7800, gold: 2380 }, dropTableId: "drop_periphery_field", skillTreeId: "st_wail_root" },
        ...
        // ========================
        // 황혼의 어귀 (twilight_reach)
        // ========================
        { id: "twilight_veil", tags: ["field","twilight_reach"], regionId: "twilight_reach", grade: "SSS", name: "황혼의 장막", level: 84, minPlayerLv: 76, maxPlayerLv: 99, stats: { hp: 38800, atk: 820, def: 540, spd: 292 }, reward: { exp: 35200, gold: 10200 }, dropTableId: "drop_twilight_field", skillTreeId: "st_wail_root" },
        { id: "twilight_revenant", tags: ["field","twilight_reach"], regionId: "twilight_reach", grade: "SSS", name: "어귀의 망령", level: 86, minPlayerLv: 77, maxPlayerLv: 99, stats: { hp: 42800, atk: 865, def: 575, spd: 305 }, reward: { exp: 39200, gold: 11200 }, dropTableId: "drop_twilight_field", skillTreeId: "st_fear_only" },
        { id: "twilight_arbiter", tags: ["boss","twilight_reach"], regionId: "twilight_reach", grade: "SSS", name: "황혼의 중재자", level: 90, minPlayerLv: 78, maxPlayerLv: 99, stats: { hp: 56000, atk: 910, def: 640, spd: 318 }, reward: { exp: 68000, gold: 19500 }, dropTableId: "drop_twilight_arbiter", isBoss: true, bossPassiveSkillIds: ["boss_p_void_heart", "boss_p_null_skin", "boss_p_crown_pressure", "boss_p_border_lock", "boss_p_restless"], bossActiveSkillIds: ["boss_guardian_verdict", "boss_hydra_maelstrom", "boss_seraph_petrify", "boss_a_overdrive", "boss_a_void_surge"], bossActiveWeights: [2, 1, 1, 1, 1], bossActiveLowHp: { threshold: 0.42, skillIds: ["boss_guardian_verdict", "boss_hydra_maelstrom", "boss_a_bloodlust", "boss_seraph_petrify", "boss_mud_quake"], weights: [2, 2, 1, 1, 1] } }
    ],
    ...
    skillTrees: {
        pilgrim: {
            ...
            clusters: [
                ...
                { id: 'ascent_martyr', name: '순교 연장', nodeIds: ['pilgrim_ascent_m_1', 'pilgrim_ascent_m_2', 'pilgrim_ascent_m_3', 'pilgrim_ascent_m_4', 'pilgrim_ascent_m_5', 'pilgrim_ascent_m_6', 'pilgrim_ascent_m_7', 'pilgrim_ascent_m_8', 'pilgrim_ascent_m_9', 'pilgrim_ascent_m_10'] },
                { id: 'ascent_tithe', name: '십일조 연장', nodeIds: ['pilgrim_ascent_t_1', 'pilgrim_ascent_t_2', 'pilgrim_ascent_t_3', 'pilgrim_ascent_t_4', 'pilgrim_ascent_t_5', 'pilgrim_ascent_t_6', 'pilgrim_ascent_t_7', 'pilgrim_ascent_t_8', 'pilgrim_ascent_t_9', 'pilgrim_ascent_t_10'] },
                { id: 'ascent_radiant', name: '광휘 연장', nodeIds: ['pilgrim_ascent_r_1', 'pilgrim_ascent_r_2', 'pilgrim_ascent_r_3', 'pilgrim_ascent_r_4', 'pilgrim_ascent_r_5', 'pilgrim_ascent_r_6', 'pilgrim_ascent_r_7', 'pilgrim_ascent_r_8', 'pilgrim_ascent_r_9', 'pilgrim_ascent_r_10'] }
            ],
            nodes: [
                ...
                { id: "pilgrim_ascent_m_1", name: "순교의 잔광 I", kind: "small", desc: "HP +10", grants: {"stats":{"hp":10}}, position: { x: 8.73, y: 16.11 } },
                { id: "pilgrim_ascent_m_2", name: "순교의 잔광 II", kind: "small", desc: "공격 +1", grants: {"stats":{"atk":1}}, position: { x: 8.4, y: 16.44 }, requiresAll: ["pilgrim_ascent_m_1"] },
                { id: "pilgrim_ascent_m_3", name: "순교의 잔광 III", kind: "small", desc: "방어 +1", grants: {"stats":{"def":1}}, position: { x: 8.43, y: 15.98 }, requiresAll: ["pilgrim_ascent_m_2"] },
                { id: "pilgrim_ascent_m_4", name: "순교의 잔광 IV", kind: "small", desc: "PP +5", grants: {"stats":{"pp":5}}, position: { x: 8.02, y: 16.2 }, requiresAll: ["pilgrim_ascent_m_3"] },
                { id: "pilgrim_ascent_m_5", name: "순교의 잔광 V", kind: "small", desc: "신앙 +1", grants: {"stats":{"faith":1}}, position: { x: 8.19, y: 15.77 }, requiresAll: ["pilgrim_ascent_m_4"] },
                { id: "pilgrim_ascent_m_6", name: "순교의 잔광 VI", kind: "small", desc: "속도 +2", grants: {"stats":{"spd":2}}, position: { x: 7.73, y: 15.85 }, requiresAll: ["pilgrim_ascent_m_5"] },
                { id: "pilgrim_ascent_m_7", name: "순교의 잔광 VII", kind: "small", desc: "HP +12", grants: {"stats":{"hp":12}}, position: { x: 8.02, y: 15.49 }, requiresAll: ["pilgrim_ascent_m_6"] },
                { id: "pilgrim_ascent_m_8", name: "순교의 잔광 VIII", kind: "small", desc: "공격 +2", grants: {"stats":{"atk":2}}, position: { x: 7.57, y: 15.43 }, requiresAll: ["pilgrim_ascent_m_7"] },
                { id: "pilgrim_ascent_m_9", name: "순교의 잔광 IX", kind: "small", desc: "방어 +2", grants: {"stats":{"def":2}}, position: { x: 7.95, y: 15.17 }, requiresAll: ["pilgrim_ascent_m_8"] },
                { id: "pilgrim_ascent_m_10", name: "순교의 잔광 X", kind: "notable", desc: "HP +18, PP +6", grants: {"stats":{"hp":18,"pp":6}}, position: { x: 7.54, y: 14.97 }, requiresAll: ["pilgrim_ascent_m_9"] },
                { id: "pilgrim_ascent_t_1", name: "헌납의 여운 I", kind: "small", desc: "PP +6", grants: {"stats":{"pp":6}}, position: { x: -10.23, y: 5.88 } },
                { id: "pilgrim_ascent_t_2", name: "헌납의 여운 II", kind: "small", desc: "신앙 +1", grants: {"stats":{"faith":1}}, position: { x: -10.54, y: 6.24 }, requiresAll: ["pilgrim_ascent_t_1"] },
                { id: "pilgrim_ascent_t_3", name: "헌납의 여운 III", kind: "small", desc: "HP +10", grants: {"stats":{"hp":10}}, position: { x: -10.56, y: 5.77 }, requiresAll: ["pilgrim_ascent_t_2"] },
                { id: "pilgrim_ascent_t_4", name: "헌납의 여운 IV", kind: "small", desc: "PP +5", grants: {"stats":{"pp":5}}, position: { x: -10.96, y: 6 }, requiresAll: ["pilgrim_ascent_t_3"] },
                { id: "pilgrim_ascent_t_5", name: "헌납의 여운 V", kind: "small", desc: "속도 +2", grants: {"stats":{"spd":2}}, position: { x: -10.83, y: 5.56 }, requiresAll: ["pilgrim_ascent_t_4"] },
                { id: "pilgrim_ascent_t_6", name: "헌납의 여운 VI", kind: "small", desc: "방어 +1", grants: {"stats":{"def":1}}, position: { x: -11.29, y: 5.65 }, requiresAll: ["pilgrim_ascent_t_5"] },
                { id: "pilgrim_ascent_t_7", name: "헌납의 여운 VII", kind: "small", desc: "PP +7", grants: {"stats":{"pp":7}}, position: { x: -11.01, y: 5.27 }, requiresAll: ["pilgrim_ascent_t_6"] },
                { id: "pilgrim_ascent_t_8", name: "헌납의 여운 VIII", kind: "small", desc: "신앙 +1", grants: {"stats":{"faith":1}}, position: { x: -11.48, y: 5.2 }, requiresAll: ["pilgrim_ascent_t_7"] },
                { id: "pilgrim_ascent_t_9", name: "헌납의 여운 IX", kind: "small", desc: "HP +12", grants: {"stats":{"hp":12}}, position: { x: -11.1, y: 4.93 }, requiresAll: ["pilgrim_ascent_t_8"] },
                { id: "pilgrim_ascent_t_10", name: "헌납의 여운 X", kind: "notable", desc: "PP +10, 치명타 +2%", grants: {"stats":{"pp":10},"specials":{"critChance":0.02}}, position: { x: -11.51, y: 4.72 }, requiresAll: ["pilgrim_ascent_t_9"] },
                { id: "pilgrim_ascent_r_1", name: "난광의 미세 I", kind: "small", desc: "공격 +1", grants: {"stats":{"atk":1}}, position: { x: -15.8, y: -10.49 } },
                { id: "pilgrim_ascent_r_2", name: "난광의 미세 II", kind: "small", desc: "치명타 +2%", grants: {"specials":{"critChance":0.02}}, position: { x: -16.18, y: -10.77 }, requiresAll: ["pilgrim_ascent_r_1"] },
                { id: "pilgrim_ascent_r_3", name: "난광의 미세 III", kind: "small", desc: "속도 +2", grants: {"stats":{"spd":2}}, position: { x: -15.71, y: -10.87 }, requiresAll: ["pilgrim_ascent_r_2"] },
                { id: "pilgrim_ascent_r_4", name: "난광의 미세 IV", kind: "small", desc: "공격 +2", grants: {"stats":{"atk":2}}, position: { x: -15.97, y: -11.27 }, requiresAll: ["pilgrim_ascent_r_3"] },
                { id: "pilgrim_ascent_r_5", name: "난광의 미세 V", kind: "small", desc: "PP +5", grants: {"stats":{"pp":5}}, position: { x: -15.5, y: -11.19 }, requiresAll: ["pilgrim_ascent_r_4"] },
                { id: "pilgrim_ascent_r_6", name: "난광의 미세 VI", kind: "small", desc: "신앙 +1", grants: {"stats":{"faith":1}}, position: { x: -15.59, y: -11.66 }, requiresAll: ["pilgrim_ascent_r_5"] },
                { id: "pilgrim_ascent_r_7", name: "난광의 미세 VII", kind: "small", desc: "치명타 +2%", grants: {"specials":{"critChance":0.02}}, position: { x: -15.18, y: -11.41 }, requiresAll: ["pilgrim_ascent_r_6"] },
                { id: "pilgrim_ascent_r_8", name: "난광의 미세 VIII", kind: "small", desc: "HP +10", grants: {"stats":{"hp":10}}, position: { x: -15.09, y: -11.88 }, requiresAll: ["pilgrim_ascent_r_7"] },
                { id: "pilgrim_ascent_r_9", name: "난광의 미세 IX", kind: "small", desc: "공격 +1", grants: {"stats":{"atk":1}}, position: { x: -14.8, y: -11.5 }, requiresAll: ["pilgrim_ascent_r_8"] },
                { id: "pilgrim_ascent_r_10", name: "난광의 미세 X", kind: "notable", desc: "공격 +2, 피해량 3% 증가", grants: {"stats":{"atk":2},"specials":{"damageMul":1.03}}, position: { x: -14.55, y: -11.91 }, requiresAll: ["pilgrim_ascent_r_9"] }
            ],
            edges: [
                ...
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_1'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_2'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_3'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_4'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_5'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_6'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_7'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_8'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_9'],
                ['pilgrim_martyr_keystone', 'pilgrim_ascent_m_10'],

                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_1'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_2'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_3'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_4'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_5'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_6'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_7'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_8'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_9'],
                ['pilgrim_tithe_ep_4', 'pilgrim_ascent_t_10'],

                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_1'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_2'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_3'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_4'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_5'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_6'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_7'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_8'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_9'],
                ['pilgrim_active_radiant_volley', 'pilgrim_ascent_r_10']
            ]
        }
    },
    ...
    items: {
        ...
        'wraith_locket': { kind: 'equipment', name: '원혼 로켓', grade: 'Epic', slot: 'accessory', stats: { faith: 3, pp: 18, lifeSteal: 0.04 }, specials: { critDamageMul: 0.04 }, equipTier: 1, desc: '서늘한 잔향이 맴도며, 망령의 각오가 치명타 피해를 살짝 끌어올립니다.' },
        ...
        'guardian_halo': { kind: 'equipment', name: '수호자의 광륜', grade: 'Epic', slot: 'helmet', stats: { def: 16, faith: 3, pp: 20 }, specials: { critDamageMul: 0.055 }, equipTier: 5, desc: '왕좌 수호자의 맹세가 남은 최상급 투구로, 신성한 집중이 치명타 피해를 보조합니다.' },
        ...
        'abyss_grimoire': { kind: 'equipment', name: '심연 그리모어', grade: 'Epic', slot: 'offhand', stats: { pp: 28, faith: 4, def: 8 }, specials: { critDamageMul: 0.075 }, equipTier: 8, desc: '봉인된 주문식이 새겨진 금서로, 금단의 구절이 치명타 피해를 끌어올립니다.' },
        'astral_circlet': { kind: 'equipment', name: '성좌 서클릿', grade: 'Epic', slot: 'helmet', stats: { def: 18, faith: 4, pp: 16 }, specials: { critDamageMul: 0.085 }, equipTier: 9, desc: '성좌 심연의 잔광을 새긴 관으로, 별자리의 압력이 치명타 피해를 강화합니다.' },
    ...
    dropTables: {
        ...
        'drop_twilight_field': [
            { itemId: 'fallen_feather', chance: 0.52 },
            { itemId: 'soul_core', chance: 0.22 },
            { itemId: 'chaos_scripture', chance: 0.3 },
            { itemId: 'astral_circlet', chance: 0.08 },
            { itemId: 'abyss_grimoire', chance: 0.1 },
            { itemId: 'guardian_oath', chance: 0.22 }
        ],
        'drop_twilight_arbiter': [
            { itemId: 'soul_core', chance: 1.0 },
            { itemId: 'fallen_feather', chance: 0.9 },
            { itemId: 'chaos_scripture', chance: 0.35 },
            { itemId: 'astral_circlet', chance: 0.14 },
            { itemId: 'guardian_halo', chance: 0.1 },
            { itemId: 'luciferian_mail', chance: 0.12 }
        ]
    },
    ...
    bossExclusiveDropTables: {
        ...
        twilight_arbiter: [
            { itemId: 'soul_core', chance: 1.0, minQty: 1, maxQty: 2 },
            { itemId: 'chaos_scripture', chance: 0.85, minQty: 1, maxQty: 2 },
            { itemId: 'astral_circlet', chance: 0.055, minQty: 1, maxQty: 1 },
            { itemId: 'abyss_grimoire', chance: 0.05, minQty: 1, maxQty: 1 }
        ]
    },
    ...
    shops: {
        ...
        twilight_reach: [
            { itemId: 'fallen_feather', price: 1620 },
            { itemId: 'soul_core', price: 1980 },
            { itemId: 'chaos_scripture', price: 1740 },
            { itemId: 'astral_circlet', price: 2920 },
            { itemId: 'abyss_grimoire', price: 2560 },
            { itemId: 'guardian_halo', price: 2520 },
            { itemId: 'smithing_shard', price: 45 },
            { itemId: 'seraph_ember', price: 560 }
        ]
    }
